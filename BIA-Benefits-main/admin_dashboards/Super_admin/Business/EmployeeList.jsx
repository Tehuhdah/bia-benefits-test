        ...
        <div className="table-container">
          <div className="overflow-x-hidden">
            ...
            >
              <AddEmployees
                onClose={closeModal}
                handleSubmit={handleSubmitBusinessDetails}
              />
            </Modal>
            <table
            ...
            >
              ...
              <tbody>
                {currentItems.map((employee) => (
                  ...
                  >
                    <td className="p-4 text-left w-1/5 cursor-pointer">
                    ...
                    <td className="p-4 text-left w-1/5">
                      {" "}
                      {employee.users.map((user) => user.email).join(", ")}
                    </td>
                    <td className="p-4 text-left w-1/5">
                      {formatUniqueId(employee.uniqueId)}
                    </td>
