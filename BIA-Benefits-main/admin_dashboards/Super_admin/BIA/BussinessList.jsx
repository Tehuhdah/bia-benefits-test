                ...
                {currentItems.map((business) => (
                  <tr key={business.id} className="hover:bg-gray-100">
                    <Link href={`/business/${business.id}`}>
                      <td className="p-4 text-left w-1/6 cursor-pointer">
                        {capitalizeFirstLetter(business.name)}
                      </td>
                    </Link>
                    <td className="p-4 text-left w-1/6">
                      {capitalizeFirstLetter(business.addresses[0]?.city)}
                    </td>
                    <td className="p-4 text-left w-1/6">
                      {getCategoryName(business.category)}
                    </td>
                    <td className="p-4 text-left w-1/6">
                      {capitalizeFirstLetter(business.street1)}
                    </td>
                    <td className="p-4 text-left w-1/6">
                      {business.postalCode.toUpperCase()}
                    </td>
